...
interface FilterPopoverAnaliseProps {
	trigger?: ReactNode;
	open?: boolean;
	...
	return (
		<Popover open={open} onOpenChange={handleOpenChange}>
			...
			<PopoverContent
				align="end"
				className={cn(
					"w-auto max-w-none rounded-lg border border-gray-200 bg-background-card p-2 shadow-lg overflow-visible dark:border-border/30",
					"data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2"
				)}
				style={{ width: 'auto', minWidth: 360, maxWidth: maxWidthStyle }}
			>
...
export default memo(FilterPopoverAnalise);
